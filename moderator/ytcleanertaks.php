...
foreach ($videos as $video) {
	...
	<a target="_blank" class="btn btn-sm btn-outline btn-default confirm" href="<?php echo admin_url('videos');?>&delete-video=<?php echo $video->id;?>">
		<i class="material-icons mright10"> delete </i> unlist
		</a>
		<a target="_blank" class="btn btn-sm btn-raised btn-primary" href="<?php echo admin_url('edit-video');?>&vid=<?php echo $video->id;?>">
		<i class="material-icons mright10"> edit </i> modify
		</a>
		<a target="_blank" class="btn btn-sm btn-outline btn-danger confirm" href="<?php echo admin_url('unvideos');?>&delete-video=<?php echo $video->id;?>">
