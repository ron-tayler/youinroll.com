...
<a href="https://smartfooded.com" class="btn btn-primary tipS mleft20" title="<?php echo _lang("Start Lesson"). ' '._html($profile->name); ?>"><!--i class="material-icons">headset_mic</i--><i class="icon-user"></i> <?php echo _lang("Start Lesson");?></a>
</div>
