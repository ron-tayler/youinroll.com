...
if ($result) {
	...
	echo '<div style="margin-bottom: 40px;" id="'.$goplaynext.'" class="PlayUP block text-right">
	<div class="pull-left text-left inline-block media-middle">
	<strong>'._lang('Next play:').' </strong>
	</div>
	<div class="pull-right text-left inline-block media-middle">
	
	 <div class="material-switch pull-right">
                            <input id="someSwitchOptionDanger" name="someSwitchOption001" type="checkbox" '.$autoplay.'/>
                            <label for="someSwitchOptionDanger" class="label-danger"></label>
                            <span style="margin-left: 20px;">'._lang('Autoplay').'</span>
                        </div>
