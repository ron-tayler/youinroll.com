...
function(a, b, c) {
    b.extend(c.shares, {
        ...
        vkontakte: {
            label: "Vk",
            logo: "fa fa-vk",
            shareUrl: "https://vk.com/share.php?url={url}&text={text}",
            countUrl: "",
            shareIn: "popup"
        },
        telegram: {
...
$("#jsshare").jsSocials({
    ...
    showCount: true,
    url: location.href,
    text: $('title').text() + ' ' + $('meta[name="description"]').attr('content'),
    shares: ["facebook", "email", "twitter", "viber", "vkontakte", "telegram", "whatsapp"]
});