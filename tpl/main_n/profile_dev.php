...
<div id="profile-content" class="row" id='channelBlock'>
    ...
    background-attachment: fixed;">
        ...
        <div class='channel-info'>
          <img class="channel-image img-circle inline mright20" src="<?=thumb_fix($profile->avatar, true, 130, 130);?>" data-name="<?=addslashes($profile->name); ?>">
              ...
              <?php
                switch(_get('sk')){
                  ...
                  case 'videos':
                      ...
                      $bp = bpp();
                      include_once(TPL.'/profile/user_videos_dev.php');
                    break;
                  ...
                  default:
                    ...
                    include_once(TPL.'/profile/user_profile_dev.php');
