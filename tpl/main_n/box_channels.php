...
<li class="subitem">
		<a class="block text-center" data-id="'.$user->id.'" title="'.$full_title.'" href="'.$url.'">
					<img class="img-circle cartistic" src="'.thumb_fix($user->avatar, true, 100, 100).'" data-name="'.$full_title.'" style="width:100px; height:100px" alt="image" />
		<span class="btn btn-block member-name">'._html($title).'</span>
		</a>
		<div class="block">';
