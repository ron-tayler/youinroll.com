...
<div class="video-holder row">
    ...
    <div id="renderPlaylist">
        ...
        <div class="<?php if (!has_list()) {
            echo "col-md-8 col-xs-12";
        } else {
            echo "row block player-in-list";
        } ?> ">
            <div id="video-content" class="<?php if (has_list()) {
                echo "col-md-8 col-xs-12";
            } else {
                echo "row block";
            } ?>">
                ...
                <h1>
                    ...
                    if (intval($listest) > 0) {
                        ...
                        if (isset($thesorts[$thesort])) {
                            ...
                            <a class="dropdown-toggle tipS" title="<?php echo $thesorts[$thesort]; ?>"
                               data-toggle="dropdown" href="#" aria-expanded="false" data-animation="scale-up"
                               role="button">
...
<?php } ?>
<? if (!isset($_GET['list'])) { ?>
    <div class="rur video-under-right oboxed <?php if (has_list()) {
        echo "mtop10";
    } ?> pull-right col-md-4 col-xs-12">
        <?php do_action('before-related');
        echo _ad('0', 'related-videos-top'); ?>
...
<div class="video-under col-md-8 col-xs-12">
        ...
        <div class="row vibe-interactions">
            ...
            <div class="user-media-actions">
                <div class="interaction-icons">
                    ...
                    <div class="likes-bar">
                        ...
                        <div class="aaa ">
                            <a href="javascript:iHateThis(<?php echo $video->id; ?>)" id="i-dislike-it"
                               class="pv_tip dislikes <?php if ($is_disliked) {
                                   echo 'isLiked';
                               } ?>" data-toggle="tooltip" data-placement="top"
                               title=" <?php echo _lang('Dislike'); ?>">
                                <!-- <i class="material-icons">&#xE8DB;</i> -->
                    ...
                    <?php if (is_user()) { ?>
                        <div class="aaa">
                            <a data-toggle="modal" id="dLabel" data-target="#addPlaylistModal" class="dropdown-toogle"
                               title=" <?php echo _lang('Add To'); ?>">
                                <!-- <i class="material-icons ico-flipped">&#xE03B;</i> -->
                    ...
                    <div class="aaa">
                        <a class="tipS" title=" <?php echo _lang('Report'); ?>" data-target="#report-it"
                           data-toggle="modal" href="javascript:void(0)" title=" <?php echo _lang('Report media'); ?>">
                            <!-- <i class="material-icons">&#xE153;</i> -->
                        </a>
                    </div>
                </div>
    ...
    <? } ?>
    <!-- Modal -->
    <div class="modal fade" style='margin: 0 auto' id="modal" tabindex="-1" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
...
<div class="fb-like pull-left" data-href="<?php /*echo $canonical;*/ ?>" data-width="124" data-layout="standard" data-colorscheme="dark" data-action="like" data-show-faces="true" data-share="true"></div>
        ...
        <? if (is_user()) { ?>
            <!-- Modal -->
            <div class="modal fade" id="addPlaylistModal" tabindex="-1" role="dialog" aria-labelledby="addPlaylistModal"
                 aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div style='display:flex;-webkit-box-orient:column;flex-flow: column;'>
                                <a title="<?php echo _lang("Смотреть позже"); ?>" data-id="<?= later_playlist() ?>"
                                   href="javascript:Padd(<?php echo $video->id; ?>,<?php echo later_playlist(); ?>)">
                                    <!-- <i class="material-icons  ico-flipped">&#xE924;</i> -->
                                ...
                                <?php if ($playlists) { ?>
                                    <?php foreach ($playlists as $pl) { ?>
                                        <a data-id="<?= $pl->id ?>"
                                           href="javascript:Padd(<?php echo $video->id; ?>,<?php echo $pl->id; ?>)"
