<div id="sidebar" class="<?php if(is_video() || is_picture() || is_com('stream') || is_com('conversation')) {echo 'hide-all';} elseif(is_com('home')){echo 'hide';} else {echo '';} ?> animated zoomInLeft">
	...
	{
		echo '"><a href="'.site_url().'"><span class="iconed"><img src="/tpl/main/icon-menu/home.png" alt="icon" /></span> '._lang('Home').'</a><span class="tooltip-item" style="margin-left:-8px">'._lang('Home').'</span></li>';
	}
	...
	if(is_user())
	{
		...
		echo '<li class="lihead';
		if ($_SERVER['REQUEST_URI'] == '/conversation/0/') {echo ' item-activ';}
