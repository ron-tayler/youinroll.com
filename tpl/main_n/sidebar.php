<div id="sidebar" class="<?php if(is_video() || is_picture() || is_com('stream') || is_com('conversation')) {echo 'hide';} ?> animated zoomInLeft"> 
...
<div class="sidebar-nav blc"><ul id="subscribtionItems">
</ul>
<button id="subscriptionDropdown" class="btn btn-secondary dropdown-toggle" type="button" data-page="1">
<?= _lang('Expand'); ?>
</button>
