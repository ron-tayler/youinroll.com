...
if(isset($heading) && !empty($heading)) { 
    ...
    case 'Most viewed images':
        $h1_text = "Самые просматриваемые изображения";
        break;
    case 'Most liked images':
        $h1_text = "Самые понравившиеся";
        break;
    case 'Most commented images':
        $h1_text = "Самые комментируемые изображения";
        break;
    default:
...
if(isset($heading_plus) && !empty($heading_plus)) { $heading_plus = str_replace('Рекомендуемые inages', 'Рекомендуемые изображения', $heading_plus);
	echo '<small class="videod">'.$heading_plus.'</small>';}
if ($images) {
