...
<span class="badge">' . $paid->payment_gross . ' ' . $paid->currency_code . ' </span> ' . time_ago($paid->valid_from) . ' ' . _lang('with') . ' ' . $paid->payment_method . ' ' . obfuscate_email($paid->payer_email) . '  ' . _lang('for premium until') . ' ' . $paid->valid_to . '
        ...
        $a->set_values($count->nr); ?>
            <form id='playlistsForm' class="styled"
                  action="<?php echo site_url() . me; ?>?sk=<?php echo _get('sk'); ?>&p=<?php echo this_page(); ?>"
                                ...
                                <div class="item-in-list">
                                    ...
                                    <div class="segment">
                                        <a class="" target="_blank"
                                           href="<?php echo video_url($video->id, $video->title); ?>"
                                           title="<?php echo _lang("View"); ?>"> <img
                                                    src="<?php echo thumb_fix($video->thumb, true, get_option('thumb-width'), get_option('thumb-height')); ?>"
                                                    style=""> </a>
                                        <a class="content-title mleft10" target="_blank"
                                           href="<?php echo video_url($video->id, $video->title); ?>"
                                           title="<?php echo _lang("View"); ?>"><strong><?php echo _html($video->title); ?></strong>
                                        </a>
                                    </div>
                                    <div class="segment">
                                        <div class="btn-group">
                                            <? $playlists = $db->get_results("SELECT id,title FROM vibe_playlists WHERE owner = " . toDb(user_id()) . " AND price IS NOT NULL"); ?>
                                            <select class='form-control addToPlayList' data-video="<?= $video->id ?>"
                                                    name='playlist'>
                                            ...
                                            <a class="btn  btn-primary "
                                               href="<?php echo site_url() . me; ?>?sk=edit-video&vid=<?php echo $video->id; ?>"
                                               title="<?php echo _lang("Edit"); ?>"><i class="icon-pencil" style=""></i></a>
                                            <a class="btn  btn-default btn-outline "
                                               href="<?php echo site_url() . me; ?>?sk=videos&p=<?php echo this_page(); ?>&delete-video=<?php echo $video->id; ?>"
                                               title="<?php echo _lang("Unpublish"); ?>"><i class="icon-trash"
                                                                                            style=""></i></a>
                                        </div>
                                    </div>
                                </div>
        ...
        if ($images) {
            ...
            $a->set_per_page(bpp());
            $a->set_values($count->nr); ?>
            <form class="styled" action="<?php echo site_url() . me; ?>?sk=images&p=<?php echo this_page(); ?>"
                  enctype="multipart/form-data" method="post">
                <div class="cleafix full">
                </div>
                <div class="row top10 left10">
                    <div class="div div-checks">
                        ...
                        <div class="content--items"> <?php foreach ($images as $image) { ?>
                                <div class="item-in-list">
                                    ...
                                    <div class="segment">
                                        <a class="" target="_blank"
                                           href="<?php echo image_url($image->id, $image->title); ?>"
                                           title="<?php echo _lang("View"); ?>"> <img
                                                    src="<?php echo thumb_fix($image->thumb, true, get_option('thumb-width'), get_option('thumb-height')); ?>"
                                                    style=""> </a>
                                        <a class="content-title" target="_blank"
                                           href="<?php echo image_url($image->id, $image->title); ?>"
                                           title="<?php echo _lang("View"); ?>"><strong><?php echo _html($image->title); ?></strong>
                                        </a>
                                    </div>
                                    <div class="segment">
                                        <div class="btn-group">
                                            <a class="btn btn-sm btn-primary "
                                               href="<?php echo site_url() . me; ?>?sk=edit-image&vid=<?php echo $image->id; ?>"
                                               title="<?php echo _lang("Edit"); ?>"> <i class="icon-pencil"
                                                                                        style=""></i></a>
                                            <a class="btn btn-sm btn-default btn-outline "
                                               href="<?php echo site_url() . me; ?>?sk=images&p=<?php echo this_page(); ?>&delete-image=<?php echo $image->id; ?>"
                                               title="<?php echo _lang("Unpublish"); ?>"> <i class="icon-trash"
                                                                                             style=""></i></a>
                                        </div>
                                    </div>
        ...
        ?>
            <div class="row blc mIdent">
                ...
                <div class="col-md-7 col-md-offset-1">
                    ...
                    <p>
                        <a class="btn btn-sm btn-primary"
                           href="<?php echo site_url(); ?>forward/<?php echo $likes_playlist; ?>"><i
                                    class="icon-play"></i><?php echo _lang('Play all'); ?> </a></p>
                </div>
            </div>
            <?php
        if ($videos) {
            ...
            $a->set_per_page(bpp());
            $a->set_values($count->nr); ?>
            <form class="styled" action="<?php echo site_url() . me; ?>?sk=likes&p=<?php echo this_page(); ?>"
                  enctype="multipart/form-data" method="post">
                <div class="cleafix full">
                </div>
                <div class="row top10">
                        ...
                        <div class="content--items">
                            <?php foreach ($videos as $video) { ?>
                                <div  class="item-in-list">
                                    ...
                                    <div class="segment">
                                        <a class="" target="_blank"
                                           href="<?php echo video_url($video->id, $video->title, $likes_playlist); ?>"
                                           title="<?php echo _lang("View"); ?>"> <img
                                                    src="  <?php echo thumb_fix($video->thumb, true, get_option('thumb-width'), get_option('thumb-height')); ?>"
                                                    style=""> </a>
                                        <a class="content-title" target="_blank"
                                           href="<?php echo video_url($video->id, $video->title, $likes_playlist); ?>"
                                           title="  <?php echo _lang("View"); ?>">    <?php echo _html($video->title); ?>
                                            <span class="badge badge-primary mleft20"><?php echo video_time($video->duration); ?></span>
                                        </a>
                                    </div>
                                    <div class="segment">
                                        <a class=""
                                           href="<?php echo site_url() . me; ?>?sk=likes&p=<?php echo this_page(); ?>&delete-like=<?php echo $video->id; ?>"
                                           title="<?php echo _lang("Remove rating"); ?>"> <i class="icon-trash"
                                                                                             style=""></i> </a>
                                    </div>
                                </div>
                            <?php } ?>
...
";
        ...
        if ($images) {
            ...
            $a->set_per_page(bpp());
            $a->set_values($count->nr); ?>
            <form class="styled" action="<?php echo site_url() . me; ?>?sk=hearts&p=<?php echo this_page(); ?>"
                  enctype="multipart/form-data" method="post">
                <div class="cleafix full">
                </div>
                <div class="row top10">
                        ...
                        <div class="content--items"> <?php foreach ($images as $image) { ?>
                                <div class="item-in-list">
                                    ...
                                    <div class="segment">
                                        ...
                                        <a class="content-title" target="_blank"
                                           href="<?php echo image_url($image->id, $image->title); ?>"
                                           title="<?php echo _lang("View"); ?>"> <?php echo _html($image->title); ?> </a>
                                    </div>
                                    <div class="segment">
                                        <div class="btn-group">
                                            <a class="btn btn-sm btn-default btn-outline "
                                               href="<?php echo site_url() . me; ?>?sk=hearts&p=<?php echo this_page(); ?>&delete-heart=<?php echo $image->id; ?>"
                                               title="<?php echo _lang("Remove rating"); ?>"> <i class="icon-trash"
                                                                                                 style=""></i> </a>
                                        </div>
                                    </div>
                ...
                <div class="col-md-7 col-md-offset-1">
                    ...
                    <p>
                        <a class="btn btn-sm btn-success"
                           href="<?php echo site_url(); ?>forward/<?php echo $history_playlist; ?>"><i
                                    class="icon-play"></i><?php echo _lang('Play all'); ?> </a></p>
                </div>
            </div>
            <?php
                                ...
                                <div  class="segment">
                                    ...
                                    <a class=""
                                       ...
                                       title="<?php echo _lang("View"); ?>">
                                        <?php echo _html($video->title); ?> <span
                                                class="badge badge-primary mleft20"><?php echo video_time($video->duration); ?></span>
                                    </a>
                                </div>
                            </div>
                        <?php } ?>
        ...
        $videos = $db->get_results("select " . DB_PREFIX . "videos.id," . DB_PREFIX . "videos.title," . DB_PREFIX . "videos.thumb, " . DB_PREFIX . "videos.views, " . DB_PREFIX . "videos.liked, " . DB_PREFIX . "videos.duration FROM " . DB_PREFIX . "playlist_data LEFT JOIN " . DB_PREFIX . "videos ON " . DB_PREFIX . "playlist_data.video_id = " . DB_PREFIX . "videos.id WHERE " . DB_PREFIX . "playlist_data.playlist =  '" . later_playlist() . "' and " . DB_PREFIX . "videos.pub > 0 ORDER BY " . DB_PREFIX . "playlist_data.id DESC " . this_limit()); ?>
            <div class="row blc mIdent">
                ...
                <div class="col-md-7 col-md-offset-1">
                    ...
                    <p>
                        <a class="btn btn-sm btn-success"
                           href="<?php echo site_url(); ?>forward/<?php echo $later_playlist; ?>"> <i
                                    class="icon-play"></i><?php echo _lang('Play all'); ?></a> </a> </p>
                </div>
            </div>
            <?php
        if ($videos) {
                            ...
                            <div class="item-in-list">
                                <div  class="segment">
                                    <a class=""
                                       ...
                                       title="  <?php echo _lang("View"); ?>">
                                        <img src="<?php echo thumb_fix($video->thumb, true, get_option('thumb-width'), get_option('thumb-height')); ?>"
                                             style=""> </a>
                                    <a class=""
                                       href="<?php echo video_url($video->id, $video->title, $later_playlist); ?>"
                                       title="<?php echo _lang("View"); ?>">
                                ...
                                <div class="segment">
                                    <a class=""
                                       href="<?php echo site_url() . me; ?>?sk=later&p=<?php echo this_page(); ?>&removelater=<?php echo $video->id; ?>"
                                       title="<?php echo _lang("Remove this"); ?>"> <i class="icon-trash"></i> </a>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
...
border-color: #3598dc;
	...
	<!--		<i class="icon-list-alt" style="width:140px;height:140px" ></i> -->
        ...
        if ($videos) {
            ...
            $a->set_values($count->nr);
            $a->show_pages($ps); ?>
            <form class="styled mtop10"
                  action="<?php echo site_url() . me; ?>?sk=playlists&p=<?php echo this_page(); ?>"
                  enctype="multipart/form-data" method="post">
                <div class="cleafix full">
                </div>
                <div class="row top10">
...
<!--
        ...
        $albums = $db->get_results("SELECT * FROM " . DB_PREFIX . "playlists where owner= '" . user_id() . "' and picture not in ('[likes]','[history]','[later]') and ptype > 1 order by title desc " . this_limit() . ""); ?>
            <div class="row blc mIdent">
                ...
                <div class="col-md-7 col-md-offset-1">
                    ...
                    <p>
                        <a class="btn btn-default" href="<?php echo site_url() . me; ?>/?sk=new-album"> <i
                                    class="icon-camera"></i> <?php echo _lang('Create a new album'); ?>        </a></p>
                </div>
            </div>
            <?php
        if ($albums) {
            ...
            $a->set_values($count->nr);
            $a->show_pages($ps); ?>
            <form class="styled mtop10" action="<?php echo site_url() . me; ?>?sk=albums&p=<?php echo this_page(); ?>"
                  enctype="multipart/form-data" method="post">
                <div class="cleafix full">
                </div>
                <div class="row top10">
                        ...
                        <div class="content--items">
                            <?php foreach ($albums as $album) { ?>
                                <div class="item-in-list">
                                    ...
                                    <div class="segment">
                                        <a class="btn btn-sm "
                                           href="<?php echo site_url() . me; ?>?sk=manage-albums&album=<?php echo $album->id; ?>"
                                           title="<?php echo _lang("Manage pictures in ");
                                           echo _html($album->title); ?>"> <i
                                                    class="icon icon-navicon"></i> <?php echo _lang("Manage pictures "); ?>
                                        </a>
                                    </div>
                                    <div class="segment">
                                        <a class="" target="_blank"
                                           href="<?php echo playlist_url($album->id, $album->title); ?>"
                                           title="<?php echo _lang("View"); ?>"> <img
                                                    src="<?php echo thumb_fix($album->picture, true, get_option('thumb-width'), get_option('thumb-height')); ?>"
                                                    style=""> </a>
                                        <a class="content-title" target="_blank"
                                           href="<?php echo playlist_url($album->id, $album->title); ?>"
                                           title="<?php echo _lang("View"); ?>">
                                            <strong><?php echo _html($album->title); ?> </strong> </a>
                                    </div>
                                    <div class="segment">
                                        <a class="btn btn-sm btn-default btn-outline "
                                           href="<?php echo site_url() . me; ?>?sk=albums&p=<?php echo this_page(); ?>&delete-playlist=<?php echo $album->id; ?>"
                                           title="<?php echo _lang("Delete playlist"); ?>"> <i class="icon-trash"></i>
                                        </a>
                                    </div>
                                </div>
                            <?php } ?>
        ...
        $videos = $db->get_results($vq); ?>
            <div class="row blc mIdent">
                ...
                <div class="col-md-7 col-md-offset-1">
                    ...
                    <p>
                        <a class="btn btn-sm btn-success"
                           href="<?php echo site_url(); ?>forward/<?php echo $play_check->id; ?>"> <i
                                    class="icon-play"></i> <?php echo _lang('Play all'); ?></a></p>
                </div>
            </div>
            <?php
        if ($videos) {
            $ps = site_url() . me . '?sk=manage-playlists&playlist=' . _get("playlist") . '&p=';
            $a = new pagination;
            $a->set_current(this_page());
            $a->set_first_page(true);
            $a->set_pages_items(7);
            ...
            ?>
            <form class="styled"
                  action="<?php echo site_url() . me; ?>?sk=manage-playlists&playlist=<?php echo _get("playlist"); ?>"
                  enctype="multipart/form-data" method="post">
                <div class="cleafix full">
                </div>
                <div class="row top10">
                        ...
                        <div class="content--items">
                            <?php foreach ($videos as $video) { ?>
                                <div class="item-in-list">
                                    <div class="segment">
                                        <div class="checkbox-custom checkbox-primary">
                                            <input type="checkbox" name="playlistsRemoval[]"
                                    ...
                                    <div class="segment">
                                        <p>
                                            <a class="btn"
                                               href="<?php echo site_url() . me; ?>?sk=manage-playlists&playlist=<?php echo _get("playlist"); ?>&remove=<?php echo $video->id; ?>">
                                                <i class="material-icons">&#xE872;</i></a></p>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
        ...
        if (_get("album") && _get("remove") && $play_check) {
            playlist_remove(_get("album"), _get("remove"));
        }
        if (_get("album") && isset($_POST['albumsRemoval']) && $play_check) {
            playlist_remove(_get("album"), $_POST['albumsRemoval']);
        }
        $count = $db->get_row("SELECT count(*) as nr FROM " . DB_PREFIX . "playlist_data where playlist= '" . toDb($play_check->id) . "'");
        ...
        $images = $db->get_results($vq); ?>
            ...
            <?php
        if ($images) {
            $ps = site_url() . me . '?sk=manage-albums&p=';
            $a = new pagination;
            $a->set_current(this_page());
            $a->set_first_page(true);
            $a->set_pages_items(7);
            ...
            ?>
            <form class="styled"
                  action="<?php echo site_url() . me; ?>?sk=manage-albums&album=<?php echo _get("album"); ?>"
                  enctype="multipart/form-data" method="post">
                <div class="cleafix full">
                </div>
                <div class="row top10">
                        ...
                        <div class="content--items">
                            <?php foreach ($images as $video) { ?>
                                <div class="item-in-list">
                                    ...
                                    <div class="segment">
                                        <a class="btn btn-sm btn-default btn-outline"
                                           href="<?php echo site_url() . me; ?>?sk=manage-albums&album=<?php echo _get("album"); ?>&remove=<?php echo $video->id; ?>">
   ...
   ';
        ...
        if ($video) { ?>
            <div class="row odet mbot20 text-center">
                <iframe id="previewer" width="853" height="480" style="max-width:100%"
                        src="<?php echo site_url() . embedcode . '/' . _mHash($video->id) . '/'; ?>" frameborder="0"
...
';
            ...
            <div class="row odet mbot20">
                <form id="validate" class="styled"
                      action="<?php echo site_url() . me; ?>?sk=edit-video&vid=<?php echo $video->id; ?>"
                      enctype="multipart/form-data" method="post">
...
'; ?> <span class="help-block"
            id="limit-text"> <?php echo _lang("Select only if you wish to change the image"); ?> </span>
                        </div>
                    </div>
                    <div class="control-group blc row mtop10">
                        <label class="control-label">      <?php echo _lang("Title"); ?> </label>
                        <div class="controls">
                            <input type="text" name="title" class="validate[required] form-control col-md-12"
                                   value="<?php echo $video->title; ?>" required/>
                        </div>
                    </div>
                    <div class="control-group blc row mtop10">
                        ...
                        <div class="controls">
                            <textarea rows="5" cols="5" name="description"
                                      class="auto validate[required] form-control col-md-12"
                                      style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 88px;"><?php echo $video->description; ?></textarea>
                        </div>
                    </div>
                    <div class="control-group blc row mtop10">
                        ...
                        <div class="controls">
                            <input type="text" id="duration" name="duration"
                                   class="validate[required] form-control col-md-12"
                    ...
                    <div class="control-group blc row mtop10">
                        ...
                        <div class="controls">
                            <input type="text" id="tags" name="tags" class="tags col-md-12"
                                   value="<?php echo $video->tags; ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
...
';
        ...
        if (!_get("vid")) {
            die(_lang("Missing image id"));
        }
        if ((get_option('uploadrule') <> 1) && !is_moderator()) {
            die(_lang("Image editing has been disabled by the administrator"));
        }
        $image = $db->get_row("SELECT * from " . DB_PREFIX . "images where user_id= '" . user_id() . "' and id = '" . intval(_get("vid")) . "' ");
        if ($image) { ?>
            <div class="row odet mbot20">
                <form id="validate" class="styled"
                      action="<?php echo site_url() . me; ?>?sk=edit-image&vid=<?php echo $image->id; ?>"
                      enctype="multipart/form-data" method="post">
                    ...
                    <div class="control-group blc row mtop10">
                        ...
                        <div class="controls">
                            <input type="text" name="title" class="validate[required] form-control col-md-12"
                                   value="<?php echo $image->title; ?>" required/>
                        </div>
                    </div>
                    <div class="control-group blc row mtop10">
                        <label class="control-label">      <?php echo _lang("Description"); ?>      </label>
                        <div class="controls">
                            <textarea rows="5" cols="5" name="description"
                                      class="auto validate[required] form-control col-md-12"
                                      style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 88px;"> <?php echo $image->description; ?></textarea>
                        </div>
                    </div>
                    <div class="control-group blc row mtop10">
                        <label class="control-label">      <?php echo _lang("Category:"); ?>      </label>
...
';
            ...
            <div class="row odet">
                <form id="validate" action="<?php echo site_url() . me; ?>?sk=new-album" enctype="multipart/form-data"
                      method="post">
                    <div class="control-group">
                        <label class="control-label"> <?php echo _lang("Title"); ?>           </label>
                        <div class="controls">
                            <input type="text" name="album-name" class="validate[required] form-control col-md-12"
                                   placeholder="<?php echo _lang("Your album's title"); ?> required"/>
                        </div>
                    </div>
                    <div class="control-group mtop20 row">
                        <label class="control-label"> <?php echo _lang("Description"); ?> </label>
                        <div class="controls">
                            <textarea rows="5" cols="5" name="album-desc"
                                      class="auto validate[required] form-control col-md-12"
                                      style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 88px;"></textarea>
                        </div>
                    </div>
                    <div class="control-group mtop20 row">
...
';
            ...
            <div class="row odet">
                <form id="validate" action="<?php echo site_url() . me; ?>?sk=new-playlist"
                      enctype="multipart/form-data" method="post">
                    <div class="control-group">
                        <label class="control-label"> <?php echo _lang("Title"); ?> </label>
                        <div class="controls">
                            <input type="text" name="play-name" required class=" form-control col-md-12"
                                   placeholder="<?php echo _lang("Your playlist's title"); ?>"/>
                        </div>
                    </div>
                    ...
                    <div class='paymentValues'>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" max="10000" min="0" name="play-price"
                                       class=" form-control col-md-12"
                                       placeholder="<?php echo _lang("Your playlist's price (can be empty)"); ?>"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label"> <?php echo _lang("Your Card Number"); ?> </label>
                            <div class="controls">
                                <input type="number" name="play-card" class=" form-control col-md-12"
                                       placeholder="<?php echo _lang("Your card number"); ?>"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group mtop20 row">
                        <label class="control-label"><?php echo _lang("Description"); ?> </label>
                        <div class="controls">
                            <textarea rows="5" cols="5" name="play-desc" class="auto  form-control col-md-12"
                                      style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 88px;"></textarea>
                        </div>
                    </div>
                    <div class="control-group mtop20 row">
...
'; ?>
    ...
    <div id="DashSidebar" class="col-md-2 col-xs-12"> <?php do_action('dashSide-top'); ?>
       ...
       <!--         <li class=""><a href="<?php echo site_url(); ?>dashboard/?sk=activity"><i class="material-icons">&#xE7F7;</i><?php echo _lang("Activities"); ?>
                ...
                <li class="left20"><a href="<?php echo site_url() . me; ?>?sk=albums"><i
