...
$corrections_css .= '<link rel="stylesheet" type="text/css" media="screen" href="http://xatikont.beget.tech/tpl/main/styles/corrections.css" />';
...
if(!is_user()) {
$nav .= '	
<a id="uploadNow" data-target="#login-now" data-toggle="modal" href="javascript:void(0)" class="top-link" title="'._lang("Login to upload").'"><img src="/tpl/main/images/download.svg" class="download-icon" alt="icon" /></a> 
...
$nav .= '<a id="notifs" href="'.site_url().'dashboard/" class="top-link">
...
$nav .=  '<a class="top-link" href="'.site_url().members.'/"><img src="/tpl/main/images/chanels.svg" class="chanels-icon" alt="icon" /></a>';
}
